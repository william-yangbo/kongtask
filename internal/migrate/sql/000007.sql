-- Add job_key_mode support to add_job function
-- This migration aligns with graphile-worker commit e7ab91e 
-- Adds jobKeyMode support: 'replace', 'preserve_run_at', 'unsafe_dedupe'
...
-- Update remove_job function to handle locked jobs properly
